...
import com.example.collegedocumentsharing.fragments.ClassFragment;
import com.example.collegedocumentsharing.fragments.MemberFragment;
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(id==R.id.bottom_nav_dashboard){
                    ft = getSupportFragmentManager().beginTransaction();
                    ft.replace(R.id.main_class_content,new MemberFragment());
                    ft.commit();
